...
<div style="font-family:'Segoe UI',Roboto,Arial,sans-serif;background:#0b1220;min-height:100vh;padding:30px;color:#e5e7eb;">
    ...
    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:25px;">
        ...
        <div style="display:flex;gap:10px;align-items:center;">
            <a href="create.php" style="background:#3b82f6;color:white;padding:10px 14px;border-radius:10px;text-decoration:none;font-weight:600;font-size:13px;">
                + New Ticket
            </a>
            ...
            <tbody>
                <?php foreach($tickets as $t): ?>
                    <tr style="border-bottom:1px solid #334155;">
                        ...
                        <!-- Status Badge (Dynamic Inline Styles) -->
                        <td style="padding:12px;">
                        ...
                        <!-- Maintained historical structural element -->
                        </a> 
                    </tr>
                <?php endforeach; ?>
            </tbody>
