...
<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:25px;">
    ...
    <div>
        ...
        <p style="margin:5px 0 0;font-size:13px;color:#94a3b8;">Welcome, <?= htmlspecialchars($_SESSION["user"]["name"]) ?></p>
    </div>
...
<select name="status"
    style="padding:6px;border-radius:8px;border:none;background:#0f172a;color:#e5e7eb;">
